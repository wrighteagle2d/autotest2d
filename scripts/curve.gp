...
show grid
plot 'result.d/curve' u 1:2:3:4 with errorbars lt 0 title "95% confidence interval", 'result.d/curve' u 1:2 with lines title "win rate" lt 1 lw 2
#    EOF
